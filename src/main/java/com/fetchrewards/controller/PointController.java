...
public class PointController {
	...
	// Call to add a transaction to an existing payer. If the payer doesn't have
	// enough points, or don't exist, return null
	...
	// Call to spend points using the payers' balance. If the payers don't have
	// enough points, return empty list.
	...
	public List<PayerPoints> getPayersPoints() {
		return getPointsBalance(list);
	}

	// Method to initialize a list of payer. We consider that the payers have to be
	// manually added
